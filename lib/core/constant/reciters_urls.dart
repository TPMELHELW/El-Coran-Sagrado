...
// static var customReciter =

  static Map<String, String> reciters = {
    ...
    'Hani Ar-Rifai': 'https://everyayah.com/data/Hani_Rifai_192kbps',
    'Maher Al-Muaiqly':
    ...
    'Mahmoud Khalil Al-Husary (with gaps)':
    ...
    'Nasser Al Qatami': 'https://everyayah.com/data/Nasser_Alqatami_128kbps',
    'Saood Ash-Shuraym': 'https://everyayah.com/data/Saood_ash-Shuraym_128kbps',
    'Yasser Ad-Dossari':
        'https://mirrors.quranicaudio.com/everyayah/Yasser_Ad-Dussary_128kbps'
  };

  static Map<String, String> customReciters = {
    'Abdul Basit (Mujawwad)':
        "https://verses.quran.com/AbdulBaset/Mujawwad/mp3",
    'Abdul Basit (Murattal)':
        'https://verses.quran.com/AbdulBaset/Murattal/mp3',
    ...
    'Mishary Rashid Alafasy': 'https://everyayah.com/data/Alafasy_128kbps',
    'Osama Elsendy':
        'https://firebasestorage.googleapis.com/v0/b/quraan-99140.appspot.com/o/018.mp3?alt=media&token=e4a49ee2-4681-46f8-9f35-e6b93f76c28f',
    'Mohamed El-Minshawi (Mujawwad)':
        'https://mirrors.quranicaudio.com/everyayah/Minshawy_Mujawwad_192kbps',
    'Mohamed El-Minshawi (Teacher)':
        'https://everyayah.com/data/Minshawy_Teacher_128kbps',
